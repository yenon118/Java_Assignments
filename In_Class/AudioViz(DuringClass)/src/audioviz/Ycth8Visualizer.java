 ...
 * @author WIN
 */
public class Ycth8Visualizer implements Visualizer{

    private final String name = "Ycth8 Visualizer";
    ...
    private final Double bandHeightPercentage = 1.5;
    private final Double minEllipseRadius = 5.0;  // 10.0
    private final Double rotatePhaseMultiplier = 150.0;
